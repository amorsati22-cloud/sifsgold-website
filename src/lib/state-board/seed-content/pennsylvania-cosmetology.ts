...
const facts = STATE_EXAM_FACTS.PA;
const examId = EXAM_IDS.PA;

export const PENNSYLVANIA_COSMETOLOGY_EXAM = {
  id: examId,
...
export const PENNSYLVANIA_COSMETOLOGY_QUESTIONS = assignQuestionIds(
  examId,
  buildStateQuestionBank(facts),
  "pa",
);
