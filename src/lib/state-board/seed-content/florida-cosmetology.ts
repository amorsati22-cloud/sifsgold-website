...
const facts = STATE_EXAM_FACTS.FL;
const examId = EXAM_IDS.FL;

export const FLORIDA_COSMETOLOGY_EXAM = {
  id: examId,
...
export const FLORIDA_COSMETOLOGY_QUESTIONS = assignQuestionIds(
  examId,
