...
const facts = STATE_EXAM_FACTS.CA;
const examId = EXAM_IDS.CA;

export const CALIFORNIA_COSMETOLOGY_EXAM = {
  id: examId,
...
export const CALIFORNIA_COSMETOLOGY_QUESTIONS = assignQuestionIds(
  examId,
