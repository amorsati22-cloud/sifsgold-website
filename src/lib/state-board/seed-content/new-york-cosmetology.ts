...
const facts = STATE_EXAM_FACTS.NY;
const examId = EXAM_IDS.NY;

export const NEW_YORK_COSMETOLOGY_EXAM = {
  id: examId,
...
export const NEW_YORK_COSMETOLOGY_QUESTIONS = assignQuestionIds(
  examId,
