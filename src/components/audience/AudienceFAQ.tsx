...
import type { AudienceFaqItem } from "@/types/audience-landing";

export type { AudienceFaqItem } from "@/types/audience-landing";

export function AudienceFAQ({ faqs, idPrefix }: { faqs: AudienceFaqItem[]; idPrefix: string }) {
